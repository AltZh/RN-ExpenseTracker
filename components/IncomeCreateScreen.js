...
const StackScreen = ({ navigation }) => {
  ...
  const addItem = () => {
    db.transaction((tx) => {
      tx.executeSql(
        'INSERT INTO Incomes (amount, category, comment, day, month, year) VALUES (?,?,?,?,?,?)',
    ...
    <SafeAreaView style={{ flex: 1, flexDirection: 'column', backgroundColor: "#fff"}}>
      ...
      <View style={{ padding: 16 }}>
        <TouchableOpacity onPress={addItem}>
          <View style={{ padding: 16, backgroundColor: '#afa', borderRadius: 8, borderBottomWidth: 2, borderBottomColor: '#090' }}>
